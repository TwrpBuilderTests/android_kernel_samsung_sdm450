...
static DEVICE_ATTR(power_reset, 0444, yas_power_reset_show, NULL);
static DEVICE_ATTR(sw_reset, 0444, yas_sw_reset_show, NULL);
#endif
static DEVICE_ATTR(vendor, 0444, yas_vendor_show, NULL);
static DEVICE_ATTR(name, 0444, yas_name_show, NULL);
